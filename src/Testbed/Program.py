...
# Add ibapi
import os
sys.path.append('/workspace/backend-py/src/')

from src.ibapi import wrapper
from src.ibapi.client import EClient
from src.ibapi.utils import longMaxString
from src.ibapi.utils import iswrapper

# types
from src.ibapi.common import * # @UnusedWildImport
from src.ibapi.order_condition import * # @UnusedWildImport
from src.ibapi.contract import * # @UnusedWildImport
from src.ibapi.order import * # @UnusedWildImport
from src.ibapi.order_state import * # @UnusedWildImport
from src.ibapi.execution import Execution
from src.ibapi.execution import ExecutionFilter
from src.ibapi.commission_report import CommissionReport
from src.ibapi.ticktype import * # @UnusedWildImport
from src.ibapi.tag_value import TagValue

from src.ibapi.account_summary_tags import *
...
from src.ibapi.scanner import ScanData
...
def SetupLogger():
    ...
    logging.basicConfig(filename=time.strftime("/tmp/log/pyibapi.%y%m%d_%H%M%S.log"),
                        filemode="w",
                        level=logging.DEBUG,
                        format=recfmt, datefmt=timefmt)
...
def main():
    ...
    cmdLineParser.add_argument("-p", "--port", action="store", type=int,
                               dest="port", default=6080, help="The TCP port to use")
    ...
    try:
        ...
        # ! [connect]
        app.connect("ibkr", 8888, clientId=1)
        # ! [connect]
